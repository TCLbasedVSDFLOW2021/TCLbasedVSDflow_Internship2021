...
file mkdir $OutputDirectory/$DesignName/src
file copy $NetlistDirectory/$DesignName.v $OutputDirectory/$DesignName/src
file copy $OutputDirectory/$DesignName.sdc $OutputDirectory/$DesignName/src
file copy $OutputDirectory/$DesignName $working_dir/work/tools/openlane_working_dir/openlane/designs


cd $working_dir/work/tools/openlane_working_dir/openlane

exec sh docker_call.sh
